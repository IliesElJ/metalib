...
def render_log_tab():
    ...
    """
    # Get available strategy instances
    strategy_instances = get_strategy_instances()
            ...
            current_block.append(
                html.Div(
                    [
                        ...
                        html.Span(_format_log_message(msg), style={"color": "#fca5a5"}),
                    ],
                    style={
                        "padding": "4px 0",
            ...
            current_block.append(
                html.Div(
                    [
                        ...
                        html.Span(_format_log_message(msg), style={"color": "#fcd34d"}),
                    ],
                    style={
                        "padding": "4px 0",
            ...
            current_block.append(
                html.Div(
                    [
                        ...
                        html.Span(_format_log_message(msg), style={"color": "#86efac"}),
                    ],
                    style={
                        "padding": "4px 0",
...
def _format_log_message(msg):
    """
    Format a log message with syntax highlighting for key elements.

    Args:
        msg: Log message string

    Returns:
        List of HTML spans with formatting or plain string
    """
    import re
    ...
    if prefix_match:
        ...
        parts.append(html.Span("::", style={"color": "#64748b"}))

        # Highlight numbers and prices in the rest
        rest_formatted = _highlight_values(rest)
        parts.append(rest_formatted)

        return parts

    # Fallback: just highlight values
    return _highlight_values(msg)


def _highlight_values(text):
    """Highlight numeric values and prices in text."""
    import re

    # Pattern for prices like $23760.65
    parts = []
    last_end = 0
